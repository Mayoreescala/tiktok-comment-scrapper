...
def write_to_csv(data, output_file):
    ...
    fieldnames = ['username', 'uid', 'nickname']
...
if __name__ == '__main__':
    ...
    argp.add_argument("--url", '-u', type=str, default='7299013864170032390')
    ...
    # Write to CSV
    csv_output_file = f'{output}/full.csv'
    write_to_csv(json_full, csv_output_file)
    logging.info(f'Scrapping Success, Output all data : {output}, CSV file: {csv_output_file}')
